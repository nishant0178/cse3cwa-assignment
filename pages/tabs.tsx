  ...
  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      ...
      <div style={{ display: 'flex', borderBottom: '2px solid #000', marginBottom: '20px' }}>
        <div style={{ padding: '8px 16px', border: '2px solid #000', borderBottom: 'none', background: '#000', color: 'white', cursor: 'pointer', marginRight: '2px', fontSize: '14px' }}>
          Tabs
        </div>
        <div style={{ padding: '8px 16px', border: '2px solid #000', borderBottom: 'none', background: 'white', cursor: 'pointer', marginRight: '2px', fontSize: '14px' }}>
          Pre-lab Questions
        </div>
        <div style={{ padding: '8px 16px', border: '2px solid #000', borderBottom: 'none', background: 'white', cursor: 'pointer', marginRight: '2px', fontSize: '14px' }}>
          Escape Room
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '200px 300px 1fr', gap: '20px', minHeight: '400px' }}>
        ...
        <div style={{ border: '2px solid #000', padding: '15px', backgroundColor: '#f8f8f8' }}>
          <h4 style={{margin: '0 0 15px 0', fontSize: '16px'}}>Tabs</h4>
              ...
              <div key={tab.id} style={{display: 'flex', alignItems: 'center', marginBottom: '2px'}}>
                <button
                  style={{
                    ...
                    background: tab.id === activeTab ? '#000' : 'white',
        ...
        {/* Middle - Tab Content */}
        <div style={{ border: '2px solid #000', padding: '15px', backgroundColor: '#f8f8f8' }}>
          <h4 style={{margin: '0 0 15px 0', fontSize: '16px'}}>Tabs Content</h4>
          {tabs.find(tab => tab.id === activeTab) && (
            <div>
              <div style={{marginBottom: '10px'}}>
                <label style={{display: 'block', marginBottom: '5px', fontWeight: 'bold'}}>Tab Title:</label>
                <input
                  type="text"
              ...
              <div style={{marginBottom: '15px'}}>
                <label style={{display: 'block', marginBottom: '5px', fontWeight: 'bold'}}>Tab Content:</label>
                <textarea
        ...
        {/* Right - Output */}
        <div style={{ border: '2px solid #000', padding: '10px', backgroundColor: '#f8f8f8' }}>
          <h4 style={{margin: '0 0 10px 0', fontSize: '16px'}}>Output</h4>
          <textarea
            style={{
              width: '100%',
              height: '250px',
